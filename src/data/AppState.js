...
const initialAccounts = {
  checking: {
    ...
    balance: 3092741.00, currency: 'KES', icon: '🏦',
  },
  savings: {
    id: 'acc-002', label: 'Savings Account', type: 'savings',
    number: '**** **** **** 3309', shortNumber: '1324554118',
    balance: 2934000.00, currency: 'KES', icon: '💰',
  },
  investment: {
    id: 'acc-003', label: 'Investment Portfolio', type: 'investment',
    number: '**** **** **** 7741', shortNumber: '1324554118',
    balance: 2250000.00, currency: 'KES', icon: '📈',
  },
};

const initialTransactions = [
  { id:'t001', name:'M-Pesa Transfer',     category:'Transfer',     type:'income',   amount:150000,  displayDate:'Today, 09:14 AM',     icon:'📱', color:'#4CAF50', account:'checking',   note:'Received from John Otieno' },
  ...
  { id:'t003', name:'Business Revenue',    category:'Income',       type:'income',   amount:520000,  displayDate:'Yesterday, 06:00 AM', icon:'💼', color:'#2196F3', account:'checking',   note:'Feb 2024 business income' },
  ...
  { id:'t006', name:'KCB Savings Transfer',category:'Transfer',     type:'transfer', amount:-200000, displayDate:'Feb 24, 9:00 AM',     icon:'🔄', color:'#006B3F', account:'checking',   note:'Monthly savings top-up' },
  ...
  { id:'t008', name:'Freelance Payment',  category:'Income',       type:'income',   amount:345000,  displayDate:'Feb 22, 3:00 PM',     icon:'💻', color:'#009688', account:'checking',   note:'Web design project' },
  { id:'t009', name:'KCB Visa Bill',      category:'Bills',        type:'expense',  amount:-85000,  displayDate:'Feb 22, 12:00 PM',    icon:'💳', color:'#F44336', account:'checking',   note:'Credit card payment' },
  ...
  { id:'t012', name:'Safaricom Dividend', category:'Income',       type:'income',   amount:128000,  displayDate:'Feb 19, 10:00 AM',    icon:'📊', color:'#4CAF50', account:'investment', note:'Q4 2023 dividends' },
  ...
  { id:'t014', name:'Rent – Imara Daima', category:'Housing',      type:'expense',  amount:-45000,  displayDate:'Feb 01, 8:00 AM',     icon:'🏠', color:'#3F51B5', account:'checking',   note:'February 2024 rent' },
  { id:'t015', name:'KCB Fixed Deposit',  category:'Savings',      type:'income',   amount:82000,   displayDate:'Feb 01, 6:00 AM',     icon:'🏛️', color:'#006B3F', account:'savings',    note:'Monthly interest earned' },
];
...
export function AppProvider({ children }) {
  ...
  const expensesThisMonth = transactions.filter(t => t.type === 'expense').reduce((s, t) => s + Math.abs(t.amount), 0);
  ...
  return (
    <AppContext.Provider value={{ accounts, transactions, totalBalance, incomeThisMonth, expensesThisMonth, executeTransfer }}>
      {children}
    </AppContext.Provider>
  );
}
